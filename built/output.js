...
/***/ function(module, exports, __webpack_require__) {
	...
	var incrementLetter = function incrementLetter(letter) {
	  if (letter === 'z') {
	    return 'a';
	  }
	  var val = letter.charCodeAt(0);
	  return String.fromCharCode(val + 1);
	};
	
	// TODO - did this wrong
	var increment = function increment(str) {
	...
	var triplets = alphabet.map(function (_, index) {
	  return alphabet.slice(index, index + 3).join('');
	}).slice(0, 24);
	
	var hasStraight = function hasStraight(str) {
	  return triplets.some(function (triplet) {
	    return str.indexOf(triplet) !== -1;
	  });
	};
	
	var validPassword = function validPassword(str) {
	  if (!hasStraight(str)) {
	    return false;
	  }
	...
	var hasTwoRepeated = function hasTwoRepeated(str) {
	...
	var TEST_DATA = ['hijklmmn', 'abbceffg', 'abbcegjk'];
	
	var count = 1000000;
	var nextPassword = function nextPassword(_x) {
	  var _again = true;

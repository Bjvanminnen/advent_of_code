...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	Object.keys(INFO).forEach(function (sn) {
	  ...
	  var checkField = function checkField(fieldName, val) {
	  ...
	  var isSue = checkField('children', 3) && checkField('cats', 7) && checkField('samoyeds', 2) && checkField('pomeranians', 3) && checkField('akitas', 0) && checkField('vizslas', 0) && checkField('goldfish', 5) && checkField('trees', 3) && checkField('cars', 2) && checkField('perfumes', 1);
	  if (isSue) {
	    console.log('sue: ' + sn);
	  }
	});

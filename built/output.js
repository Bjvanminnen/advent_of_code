...
/***/ function(module, exports, __webpack_require__) {
	...
	var visited = _defineProperty({}, hash.apply(undefined, locSanta), 2);
	...
	var visit = function visit(i, robo) {
	  if (i >= data.length) {
	    return;
	  }
	  var loc = robo ? locRobo : locSanta;
	
	  var _DELTAS$data$i = _slicedToArray(DELTAS[data[i]], 2);
	
	  var dx = _DELTAS$data$i[0];
	  var dy = _DELTAS$data$i[1];

...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseLine = function parseLine(line) {
	  ...
	  var sueNum = _line$split2[0];
	
	  var other = _line$split2.slice(1);
	
	  var props = other.join(':').replace(/ /g, '').split(',');
	...
	*/
	...
	DATA.forEach(function (line) {
	  ...
	  var _parseLine2 = _slicedToArray(_parseLine, 2);
	
	  var sueNum = _parseLine2[0];
	  var obj = _parseLine2[1];
	
	  INFO[sueNum] = obj;
	});
	
	Object.keys(INFO).forEach(function (sn) {
	  var obj = INFO[sn];
	  ...
	  var checkField = function checkField(fieldName, val, op) {
	    op = op || eq;
	  ...
	  var isSue = checkField('children', 3) && checkField('cats', 7, gt) && checkField('samoyeds', 2) && checkField('pomeranians', 3, lt) && checkField('akitas', 0) && checkField('vizslas', 0) && checkField('goldfish', 5, lt) && checkField('trees', 3, gt) && checkField('cars', 2) && checkField('perfumes', 1);
	  if (isSue) {
	    console.log('sue: ' + sn);
	  }
	});

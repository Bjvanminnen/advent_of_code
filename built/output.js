...
/***/ function(module, exports, __webpack_require__) {
	...
	var DATA2 = ['"qxfcsmh"', '"ffsfyxbyuhqkpwatkjgudo"', '"bycZx9dyxuafofZZZxa6ufZZaxfozomjZZolhZx6a"', '"jtqvz"', '"uzezxaZ"jgbmojtwyfbfguz"', '"vqsremfkZx8fxiknektafj"', '"wzntebpxnntZ"vqndzZ"iZx47vvjqoZ""', '"higvezZ"kZ"riewqk"', '"dlkrbhbrlfrpZZdamiauyucwhty"', '"dZ""', '"qlz"', '"ku"', '"yyZ"Z"uoaoZ"uripabop"', '"saduyrntuswlnlkuppdroZZsicxosted"', '"tj"', '"zzphopswlwdhebwkxeurvizdv"', '"xfoheirjoakrpoflesZ"nfu"', '"qZxb7ohZ"pZxceZ"n"', '"qeendpZ"ercwgywdjeylxcv"', '"dcmem"', '"Z"iZx13rZ"l"', '"iksoZxdcbvqnbrjduhZ"uqudzkiZxderwk"', '"wfdsn"', '"pwynglklryhtsqbno"', '"hcojZx63icczZ"vZ"ttr"', '"zfZx23ZZhljZZkkceZZdZZasyZ"yyfestwcdxyfj"', '"xs"', '"mZ"tvltapxdvtrxiy"', '"bmud"', '"kZ"a"', '"bZ"oas"', '"Z"yexnjjupoqsxyqnquyZ"uzfdvetqrc"', '"vdwZxe3olxfgujaj"', '"qomcxdndZ"ZZcfoeZ""', '"fpul"', '"mZ"avamefphkpv"', '"vvdnbZZxZZuhnxfwZ"dpubfkxfmeuhnxisd"', '"heyZZ"', '"ldaeigghlfey"', '"eureZ"hoyZxa5iezjpZZtm"', '"yygbZ"twbjZZrZ"Zx10gmxuhmpZ""', '"weirebpZx39mqonbtmfmd"', '"ltuzZZhsZ"e"', '"ysvmpc"', '"gZx8amjttZ"meglZ"omsaihifwa"', '"yimmm"', '"iiyqfalh"', '"cwknlaaf"', '"qZx37fegZxc6sZ"xx"', '"uayrgeurgypZZoi"', '"xhugZ"ptZ"axugllbdiggzhvy"', '"kdaarqmsjfxZxc3d"', '"Z"vkwla"', '"dZ""', '"tmrozZ"bvfinxoeZZmumZ"wmm"', '"Z"nZ"bbswxneZZpZZyrZ"qhwpdd"', '"skzlkietklkqovjhvjZxfe"', '"pbgZZpabZ"bubqafZ"obzcwxwywbsZZdhtq"', '"xxjidvqhZ"lxZZwuZ"ij"', '"daefZx5feZx5bZZkbeebZx13qnydtboof"', '"ogvazaqyZ"jZx73"', '"y"', '"nZ"tibetedldyZZgsammZ"nwu"', '"wldkvgdtqulwkad"', '"dpmxnj"', '"twybwZ"cdvfZ"mjdajurokbce"', '"ruZ"ZZlasijZ"i"', '"rocZZvraZZlhrm"', '"pbktZx60boozZ"fjlkc"', '"jZx4dytvjwrzt"', '"ZZuiwjkniumxcs"', '"cbhmZ"nexcciorZ"vZ"jZ"nazxilmfpZx47"', '"qdxngevzrlgoq"', '"Z"lrzxftytpobsdfyrtdqpjbpuwmmZx9e"', '"mdagZx0asnckZxc2ggjZ"slbZ"fjy"', '"wyqkhjuazdtcgkcxvjkpnjdae"', '"aixfkZxc0iomZx21vueob"', '"dkiiakyjpkffqlluhaetires"', '"ysspvZ"lysgkvnmwbbsy"', '"gyZ"ryexcjjxdmZ"xswssgtr"', '"s"', '"ddxv"', '"qwtZ"Zx27puilbZ"pslmbrsxhrz"', '"qdgZxc9eZZqwtknlvkolZx54oqvmchnZZ"', '"lvo"', '"b"', '"fkZ"aaZ"Z"yenwchZZZZon"', '"srigZx63hpwaavsZZZx80qzkZ"xaZ"Zxe6uZZwr"', '"yxjxujZ"ghyhhxfjZ"Zxa6qvatre"', '"yoktqxjxkzrklkoeroil"', '"Z"jfmikZ""', '"smgseztzdwldikbqrhZ""', '"jftahgctfZ"hoqy"', '"tcnhicrZ"znpgcktZ"ble"', '"vqktnkodhZ"loZ"aZZbkmdjqqnsqr"', '"ztnirfzqq"', '"s"', '"xx"', '"iqjZ"yZZhqgzflwrdsusasekyrxbpZZad"', '"ZZxzjhlaiynkiozZ"Z"bxepzimvgwt"', '"sZx36rbw"', '"mniieztwrisvdx"', '"atyfxioyZx2bZZ"', '"irdeZx85Zx5cvbahZZjekwZ"ia"', '"bdmftlhkwrprmpatZ"prfaocvp"', '"wZZk"', '"umbpausy"', '"zfauhpsangy"', '"pZ"zqyw"', '"wtztypyqvnnxzvlvipnqZ"zu"', '"deicgwqZZoqvajpbovZZorZ"kgplwu"', '"mbzlfgpiZZZZzqcidjpzqdzxityxa"', '"lfkxvhma"', '"Zxf2yduqzqrZ"ZZfakZ"pZ"n"', '"mpajacfuxotonpadvng"', '"anbZZtelzvcduZZaZxf2flfq"', '"lrsZ"ebethwpmuucZ"Zx86ygr"', '"qmvdbhtumzcZ"ci"', '"meet"', '"yopgZx0fdxdqZ"hZZugsuZxffmolxjv"', '"uhy"', '"fzgidrtzycsireghazscvmwcfmwZZt"', '"cqohkhpgvpru"', '"bihyigtnvmevxZ"xx"', '"xz"', '"zofomwotzuxsjkZ"qZ"mcZ"jsZ"dnmalhxd"', '"ZZktndduxZZfqvtZ"ibnjntjcbn"', '"ia"', '"htjadnefwetypZxd5kbrwfycbyy"', '"Z"ZZhkuxqddnao"', '"meqqszZx83luecpgaem"', '"cvksZx87frvxoZ"svqivqsdpgwhukmju"', '"sgmxiaiZZoZ"riufxwjfigrZxdf"', '"fgywdfecqufccpcdn"', '"faghjoqZx28abxnpxj"', '"zuppgzcfbZ"dctvpZ"elupZ"zxkopx"', '"xqsZx45xxdqcihbwghmzoa"', '"anbnlpZZcgcvmZ"hc"', '"xfZ"fgrngwzys"', '"nrxsjduedcyZx24"', '"Zx71sxlZ"gjZ"sdsZ"ulcruguzZZtZZssvjcwhi"', '"jhjZ"msch"', '"qpovolktfwyiuyicbfeejuZx01"', '"nkyxmbZ"qyqultgtZ"nmvzvvnxnb"', '"ycsrkbstgzqbZ"uvZZcisn"', '"s"', '"ueptjnnZ"Z"sh"', '"lpZ"zZ"dZ"mxtxiy"', '"yzjtvockdnvbubqabjourfZ"kZ"uoxwle"', '"Zx82Z"wqmZ""', '"Zxb5cwtuksZx5fpgh"', '"wd"', '"tbvf"', '"ttbmzdgn"', '"vfpiyfdejyrlbgcdtwzbnm"', '"uc"', '"otdcmhpjagqix"', '"ZZZxb1qsoZ"s"', '"scowax"', '"behpstjdhZxccqlgnqjyzZ"eesn"', '"rZxe1cbnjwzveoomkzloZZkxlfouhm"', '"jgrl"', '"kzqsZZr"', '"ctscbZx7fthwkdykoZ"Zx62pkfZ"dZxe6knmhurg"', '"tcZ"kwZx3ftt"', '"bxbZx5ccl"', '"jyrmfbphsldwpq"', '"jylpvyslZ"Z"juducjg"', '"enZZmZ"kxpqZ"wpbZZZ""', '"madouhtZ"bmdwvnyqvpnawiphgacZ""', '"vuxpkZ"ltucrw"', '"aaeZx60arr"', '"ttitnneZ"kilkrgssnrZxfdurzh"', '"oalw"', '"pcZ"Z"gktkdykzbdpkwigucqniZ"nxiqx"', '"dbrsaj"', '"bgzsowyxcbrvhtvekhshZ"qgd"', '"kudfemvkZ"Z"Z"hkbrbilZ"chkqoa"', '"zjzgjZZekbhyfzufy"', '"ZZacosZ"fqekuxqzxbmkbnnZx1ejzwrm"', '"elxahvudnZ"txtmomotgw"', '"Zx2eoxmwdhelprZ"cgiZxf7pzvb"', '"eapheklx"', '"hfvmaZ"mietvcZ"tszbbmZ"czex"', '"hZ"iiockjZZZxc1et"', '"dZ"rmjjftm"', '"qlvhdcbqtyrhlcZZ"', '"yyZ"rsucjtulmZ"coryriZ"eqjlbmk"', '"tv"', '"rZ"bfuhtZZjjgujpZ""', '"kukxvuauamtdosngdjlkauylttaokaj"', '"srgostZ"Z"rbkcqtlccuZx65ohjptstrjkzy"', '"yxwxlZZyjilwwxffrjjuazmzjs"', '"dxlwZZfkstuZ"hjrtiafhyuohZ"sewabne"', '"Zx88sjZ"v"', '"rfzprzZxecZ"oxqcluZ"krzefpZZq"', '"cfmhdbjuhrcymgxpylllyvpni"', '"ucrmjvmimmcqZx88Zxd9Z"lz"', '"lujttZ""', '"gvbqoixnZ"pmledpjmoZ"flydnwkfxllf"', '"dvxqlbshhmelskZx8bigZ"l"', '"mxZx54lmaZx8bbguxejg"', '"Zx66jdatiZxeceieo"', '"Z"iyyupixeiZx54ff"', '"xohzfZ"rbxsoksxamiu"', '"vlhthspeshzbppaZx4drhqnohjopZ"Z"mfjd"', '"fZ"tvxxlaZ"vurianZ"Z"idjqZx3aptmZxc3olep"', '"gzqz"', '"kbqZZwogyeZZaltviZZhbvmodny"', '"jZxd8"', '"ofjozdhkblvndl"', '"hbitoupimbawimxlxqze"', '"ypeleimnme"', '"xfwdrzscZZoxqamawyizviZZy"', '"enoikppxZxa1ixeZ"yoZ"gumye"', '"fb"', '"vzf"', '"zxidr"', '"cuZx31beirsywtskq"', '"lxpjbvqzztafwezd"', '"ZZjyxeuoZx18bv"', '"bZ"vawcZ"pZZZZgiernZ"b"', '"odizunxZ"Z"tZZyicdnZ"xZ"sdiz"', '"Z"Z"tebrtsi"', '"ctyzsxvZxa6pegfkwsiZ"tgyltaakytccb"', '"htxwbofchvmzbppycccliyikZxe5a"', '"ggsslefamsklezqkrd"', '"rcepZ"fnimwvvdxZ"l"', '"zyrzlqmdZx12egvqsZZllqyie"', '"Zx07gsqyrrZZrcyhyspsvn"', '"butgZ""', '"gb"', '"gywkoxfZ"jsgZZwtopxvumirqxlwz"', '"rjZ"irZ"wldwveairZx2esZ"dhjrdehbqnzl"', '"ruZ"elktnsbxufkZZejufjfjlevtZZlrzd"', '"Z"widsvok"', '"oyZ"Zx81nuesvw"', '"ay"', '"syticfacZx1cfjsivwlmyZ"pumsqlqqzx"', '"m"', '"rjjkfhZx78cfZx2brgcegZ"jmdyasZ"ZZxlvZxb6p"', '"tmuvoZ"Zx3ffdqdovjmdmkgpstotojkvZ"as"', '"jdZZojvynhxllfzzxvbnZ"wrpphcvx"', '"pz"', '"Z"twr"', '"nZZhdzmxeZ"mzjjeadlz"', '"fbZ"rprxuagvahjnri"', '"rfmexmjjghZZxrnmyvnatrvfruflaqjnd"', '"obbbdeZ"coZ"qrZ"qpiwjgqahqmZZjjpZ""', '"vpbqZ"Z"yZ"czkZZbZx52edZ"lnzepobp"', '"syzeajzfarplydipnyZ"yZ"Zxe8ad"', '"mpyodwb"', '"Zx47rakphlqqptd"', '"waZ"ojZ"aiy"', '"a"', '"ropozx"', '"qZx51nbtlwa"', '"etukvgxZZjqxlkq"', '"Z"tpZ"rahZ"pgZ"sZ"bpdtesZZtkasdhqd"', '"dnZ"qqpkikadowssbZxcahZ"dzpsfZZectZ"jdh"', '"pxunovbbrrnZZvullynZ"bnoZ"Z"Z"myfxlpZ""', '"qaixyazuryvkmoulhcqaotegfjZZmpzm"', '"bvfrbicutzbjwnZZomlZ"cfZ"dZ"ezcpvZ"j"', '"rmbrdtneudemigdhelmb"', '"aqZZaurmbhy"', '"wujqvzw"', '"gfZ"tssmvmZ"gmZ"huZx9aZxb7yjawsa"', '"hrhqqxowZxe2gsydtdspcfqyZ"zwZZou"', '"ianwwfZZykoZZtdujhhqdi"', '"xylzZ"zpvpab"', '"lwuopbeeegp"', '"aoopZx49jhhcexdmdtun"', '"ZZZZmouqqcsgmz"', '"tltuvwhveauZx43bZ"ymxjlcgiymcynwt"', '"gsugerumpyuhtjljbhrdyoj"', '"lnjmZxb8wgZ"ajh"', '"zmspueZ"nfttdonZZbZ"eww"', '"Z"wZx67jwaqZx7ernmyvsZZrmdsuwydsdZ"th"', '"ogtgvtlmcvgllyv"', '"zZ"fqiZ"rvddoehrciyl"', '"yustxxtotZ"muecZ"xvfdbzunzvveq"', '"mqslw"', '"txqnyvzmibqgjsZxb6xyZx86nfalfyx"', '"kzhehlmkholov"', '"plpmywcnirrjutjguoshZZ"', '"pydbnqofvZ"dnZZm"', '"aegqof"', '"eambmxtZZdxagooglZZzapfwwlmk"', '"afbmqitxxqhddlozuxcpjxgh"', '"vgts"', '"bfdpqtoxzzhmzcilehnflna"', '"sZ"idpz"', '"ZxcfhglyZ"nlmztwybxZ"ecezmsxaqw"', '"aackfgndqcqiy"', '"Zx22unqdlsrvgzfaohoffgxzfpirZ"s"', '"abhZ"ydvZ"kbpdhrerl"', '"bdzpg"', '"ekwgkywtmzp"', '"wtoodejqmrrgslhvnkZ"piZ"ldnogpth"', '"njroZx68qgbxZxe4afZ"ZZsuan"'];
	
	var literalChars = function literalChars(line) {
	  return line.length;
	};;
	var memoryChars = function memoryChars(line) {
	...
	var diffs = DATA2.map(function (line) {
	  return literalChars(line) - memoryChars(line);
	});
	// console.log(sum(diffs));
	
	//////
	
	var encodedChars = function encodedChars(line) {
	  var newLine = line.replace(/Z/g, '|Z').replace(/\"/g, '|"');
	  // .replace(/Z\"/g, '|Z"')
	  // .replace(/\"/g, '|"')
	  // .replace(/Zx/g, '|Zx');
	...
	var numEncodings = function numEncodings(line) {};
	
	var DATA3 = ['""', '"abc"', '"aaaZ"aaa"', '"Zx27"'];
	// const diffs2 = DATA3.map(line => [literalChars(line), encodedChars(line), encodedChars(line) - literalChars(line)]);
	// console.log(diffs2);
	var diffs2 = DATA2.map(function (line) {
	  return encodedChars(line) - literalChars(line);
	});

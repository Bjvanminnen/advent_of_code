...
/***/ function(module, exports, __webpack_require__) {
	...
	var DATA = ['Frosting: capacity 4, durability -2, flavor 0, texture 0, calories 5', 'Candy: capacity 0, durability 5, flavor -1, texture 0, calories 8', 'Butterscotch: capacity -1, durability 0, flavor 5, texture 0, calories 6', 'Sugar: capacity 0, durability 0, flavor -2, texture 2, calories 1'];
	...
	var parseLine = function parseLine(line) {
	  ...
	  var ingredient = _line$split2[0];
	  var other = _line$split2[1];
	
	  var _other$split = other.split(' ');
	
	  var _other$split2 = _slicedToArray(_other$split, 11);
	
	  var _ = _other$split2[0];
	  var _ = _other$split2[1];
	  var capacity = _other$split2[2];
	  var _ = _other$split2[3];
	  var durability = _other$split2[4];
	  var _ = _other$split2[5];
	  var flavor = _other$split2[6];
	  var _ = _other$split2[7];
	  var texture = _other$split2[8];
	  var _ = _other$split2[9];
	  var calories = _other$split2[10];
	...
	var calcField = function calcField(ingredient, num, field) {
	  var val = INFO[ingredient][field] * num;
	  return val;
	};
	
	var cookieScore = function cookieScore(ingredientList) {
	  var fields = ['capacity', 'durability', 'flavor', 'texture', 'calories'];
	  var sums = {};
	  ingredientList.forEach(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 2);
	
	    var num = _ref2[0];
	    var ingredient = _ref2[1];
	  ...
	  fields.forEach(function (field) {
	    return sums[field] = Math.max(0, sums[field]);
	  });
	...
	var shortScore = function shortScore(frosting, candy, butterscotch, sugar) {
	  return cookieScore([[frosting, 'Frosting'], [candy, 'Candy'], [butterscotch, 'Butterscotch'], [sugar, 'Sugar']]);
	};
	
	var shortScore2 = function shortScore2(butterscotch, cinnamon) {
	  return cookieScore([[butterscotch, 'Butterscotch'], [cinnamon, 'Cinnamon']]);
	};
	...
	for (var a = 0; a <= 100; a++) {
	  for (var b = 0; b <= 100 - a; b++) {
	    for (var c = 0; c <= 100 - a - b; c++) {
	      ...
	      var _shortScore = shortScore(a, b, c, d);
	
	      var _shortScore2 = _slicedToArray(_shortScore, 2);
	
	      var score = _shortScore2[0];
	      var calories = _shortScore2[1];

...
/***/ function(module, exports, __webpack_require__) {
	...
	var transform = function transform(seq) {
	  seq = seq + '|';
	  var newSeq = '';
	  var curItem = seq[0];
	  var curCount = 1;

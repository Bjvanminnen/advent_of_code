...
/***/ function(module, exports, __webpack_require__) {
	...
	var DATA = ['Faerun to Tristram = 65', 'Faerun to Tambi = 129', 'Faerun to Norrath = 144', 'Faerun to Snowdin = 71', 'Faerun to Straylight = 137', 'Faerun to AlphaCentauri = 3', 'Faerun to Arbre = 149', 'Tristram to Tambi = 63', 'Tristram to Norrath = 4', 'Tristram to Snowdin = 105', 'Tristram to Straylight = 125', 'Tristram to AlphaCentauri = 55', 'Tristram to Arbre = 14', 'Tambi to Norrath = 68', 'Tambi to Snowdin = 52', 'Tambi to Straylight = 65', 'Tambi to AlphaCentauri = 22', 'Tambi to Arbre = 143', 'Norrath to Snowdin = 8', 'Norrath to Straylight = 23', 'Norrath to AlphaCentauri = 136', 'Norrath to Arbre = 115', 'Snowdin to Straylight = 101', 'Snowdin to AlphaCentauri = 84', 'Snowdin to Arbre = 96', 'Straylight to AlphaCentauri = 107', 'Straylight to Arbre = 14', 'AlphaCentauri to Arbre = 46'];
	...
	var parseLine = function parseLine(line) {
	  ...
	  var origin = _line$split2[0];
	  var _ = _line$split2[1];
	  var dest = _line$split2[2];
	  var __ = _line$split2[3];
	  var distance = _line$split2[4];
	
	  distance = parseInt(distance, 10);
	  return { origin: origin, dest: dest, distance: distance };
	};
	...
	DATA.forEach(function (line) {
	  ...
	  var origin = _parseLine.origin;
	  var dest = _parseLine.dest;
	  var distance = _parseLine.distance;
	...
	var allCities = Object.keys(graph);
	...
	var permutations = permute(allCities);
	
	var getDistance = function getDistance(cities) {
	  var distance = 0;
	...
	permutations.forEach(function (permutation) {
	  var distance = getDistance(permutation);
